...
Locale["KeyBindModeTooltip"] = "按鍵設定";
...
Locale["GUIHidden"] = Locale["Hidden"].." (不會影響快捷鍵)";
...
Locale["SlashHelpFormatted"]	=
	...
	"可用的參數:\n"..
	"|c"..Const.LightBlue.."-bar <快捷列名稱>|r (要套用更改的快捷列名稱，沒有指定的話會套用到全部的快捷列)\n"..
	"|c"..Const.LightBlue.."-list|r\n"..
	"|c"..Const.LightBlue.."-rename <新名稱>|r\n"..
	"|c"..Const.LightBlue.."-rows <數字>|r\n"..
	"|c"..Const.LightBlue.."-cols <數字>|r\n"..
	"|c"..Const.LightBlue.."-scale <大小>|r (1 是預設縮放大小)\n"..
	"|c"..Const.LightBlue.."-gap <大小>|r (6 是預設間距)\n"..
	...
	"|c"..Const.LightBlue.."-forceoffcastonkeydown <on/off>|r (下次登入時才會套用)\n"..
...
Locale["SlashListBarWithLabel"]		= "- <LABEL> |c"..Const.LightBlue.." 例如: /bufo -bar <LABEL> -info";
Locale["SlashListBarWithIndex"]		= "- <LABEL> (沒有設定文字標籤的話改用索引值) |c"..Const.LightBlue.." 例如: /bufo -bar <LABEL> -info"
