...
do
    -- MC
    BG.Loot.MC.N.boss1 = { 16800, 16805, 16829, 16837, 16859, 16863, 18870, 17109, 19145, 19146, 18872, 18875, 18861, 18879, 19147, 17077, 18878, 16665 }
    BG.Loot.MC.N.boss2 = { 16814, 16796, 16810, 16822, 16835, 16847, 16843, 16855, 16867, 18203, 17065, 18829, 18823, 19143, 19136, 18861, 19144, 18824, 18821, 18820, 19142, 17069, 17073, 18822 }
    BG.Loot.MC.N.boss3 = { 16812, 16826, 16849, 16839, 16860, 16862, 18870, 19145, 19146, 18872, 18875, 18861, 18879, 19147, 17077, 18878 }
    BG.Loot.MC.N.boss4 = { 18564, 16813, 16795, 16808, 16821, 16834, 16846, 16842, 16854, 16866, 18829, 18823, 19143, 19136, 18861, 19144, 18824, 18821, 18820, 19142, 17066, 17071, 17105, 18832, 18822 }
    BG.Loot.MC.N.boss5 = { 16811, 16801, 16803, 16824, 16831, 16852, 18870, 19145, 19146, 18872, 18875, 18861, 18879, 19147, 17077, 18878 }
    BG.Loot.MC.N.boss6 = { 18563, 16797, 16807, 16836, 16844, 16856, 18829, 18823, 19143, 19136, 18861, 19144, 18824, 18821, 17110, 18820, 19142, 18822 }
    BG.Loot.MC.N.boss7 = { 16815, 16798, 16809, 16820, 16833, 16845, 16841, 16853, 16865, 17203, 18829, 18823, 19143, 19136, 18861, 19144, 18824, 18821, 18820, 19142, 17072, 17103, 18822, 18842 }
    BG.Loot.MC.N.boss8 = { 16816, 16823, 16848, 16868, 18870, 19145, 19146, 18872, 18875, 18861, 18879, 19147, 17077, 18878, 17074 }
    BG.Loot.MC.N.boss9 = { 19139, 18810, 18811, 18808, 18809, 18812, 18806, 19140, 18805, 18803, 18703, 18646 }
    BG.Loot.MC.N.boss10 = { 17204, 16922, 16915, 16930, 16909, 16901, 16938, 16946, 16954, 16962, 17082, 18817, 18814, 17102, 17107, 19137, 17063, 19138, 18815, 17106, 18816, 17104, 17076 }
    BG.Loot.MC.N.boss11 = { 16921, 16914, 16929, 16908, 16900, 16939, 16947, 16955, 16963, 18205, 17078, 18813, 17064, 17067, 17068, 17075, 18423, 18705, 15410, 17966 }
    BG.Loot.MC.N.boss12 = { 17011, 17010, 11382, 17012, 16817, 16802, 16806, 16827, 16828, 16851, 16838, 16858, 16864, 16819, 16799, 16804, 16825, 16830, 16850, 16840, 16857, 16861 }
    ...
    BG.Loot.TAQ.ZaXiangItems = { 21237, 21232, } -- 安其拉徽记和武器记录到杂项
