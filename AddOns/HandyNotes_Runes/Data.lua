...
st.emeraldWardens = "可向灰谷、暮色森林、費伍德森林和辛特蘭的翡翠守護者軍需官購買，需達到友善聲望。\n"
			.."聲望可透過相同區域的傳送門進行團隊/單人任務來獲得。"
st.nightmareIncursions = "暮色森林：23級以上，灰谷：37級以上，費伍德森林：47級以上，辛特蘭：47級以上\n\n"
			.."前往標記位置並與戰地指揮官交談。\n完成任務後，需要擊敗傳送門附近的惡魔生物，並與特工交談，\n"
			.."你將進入傳送門完成各種挑戰。所有這些都會獎勵\n翡翠守護者聲望。\n\n"
			.."這些任務最多可與四人共享。強烈建議組隊並共享任務。因此，\n"
			.."團隊將同時完成多個任務。\n\n"
st.leylineGuide = "參觀艾薩拉、費伍德森林、\n辛特蘭和灼熱峽谷的四個地脈匯合點。\n\n"
			.."使用術士的世界核心碎片（來自小鬼探索）或法師的土靈學卷軸。\n\n"
			.."一個憤怒的地脈行者（47級精英）將會生成。免疫奧術傷害。它會掉落一個地脈水晶。收集所有四個。完成！\n\n"
			.."聖騎士/牧師必須組隊才能完成此任務"
st.leylineSummary = "在艾薩拉、費伍德森林、辛特蘭和灼熱峽谷，你必須使用\n"
					.."土靈學卷軸（法師解碼）或世界核心碎片（術士小鬼探索）來“調諧”地脈"
st.leylineSummaryExtra = "。\n聖騎士和牧師必須與一個或多個法師/術士組隊"
st.wildGods = "在翡翠聖地（費伍德森林南部）找到影牙特使。接受“荒野諸神”任務。\n\n"
			.."在辛特蘭東南部的金棘谷殺死邪枝生物（45級精英-51級精英）以獲得荒野低語藥劑。\n\n"
			.."在剃刀沼澤（貧瘠之地最南端），完全清除最後一個首領。喝下藥劑。與阿迦瑪甘之靈交談並交接/领取“荒野諸神”的第一和第二部分。你將獲得阿迦瑪甘的咆哮。\n\n"
			.."現在前往以下其中一個地牢。當滿足擊殺條件時，你將收到一條訊息\n"
			.."“你感覺到一股陰影的存在”。前往新生成的一個幽靈野獸並使用你的阿迦瑪甘的咆哮。\n"
			.."這將召喚一個狂亂的遠古生物（52級精英）。殺死並拾取戰利品。\n你將獲得1個荒野祭品。當你收集到三個時，\n"
			.."返回影牙特使處领取你的符文。\n\n"
			..colourHighlight .."黑石深淵：" ..colourPlaintext .."擊敗格斯坦、格雷布瑪和\n"
			.."法律之環。前往高速公路並追捕幽靈的蛇怪並吹響你的號角。\n\n"
			..colourHighlight .."瑪拉頓：" ..colourPlaintext .."任意三個首領。當你收到訊息時，\n"
			.."前往塞雷布拉斯公主。附近有一個幽靈的迅猛龍。\n\n"
			..colourHighlight .."祖爾法拉克：" ..colourPlaintext .."除加茲瑞拉以外的任意三個首領。\n"
			.."在水池區域尋找幽靈的蜘蛛。"
