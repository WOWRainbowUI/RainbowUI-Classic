...
function GoToCCSettings(msg, editbox)
	if msg == "" or msg == nil then
		InterfaceOptionsFrame_OpenToCategory(L.Options[localeString]["ClassicCalendar"] or AddonTitle)
		InterfaceOptionsFrame_OpenToCategory(L.Options[localeString]["ClassicCalendar"] or AddonTitle) -- Second call works around the issue detailed at Stanzilla/WoWUIBugs/issues/89
	end
end
