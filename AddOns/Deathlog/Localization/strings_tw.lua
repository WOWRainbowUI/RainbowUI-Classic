deathlog_strings_tw = {
	...
	creature_model_quote_font = "Fonts\\blei00d.TTF",
	-- death alerts messages
	death_alert_default_message = "<name> (等級 <level> <race><class>)\n在<zone>被 <source> 殺死",
	death_alert_default_fall_message = "<name> (等級 <level> <race><class>)\n在<zone>摔死",
	death_alert_default_drown_message = "<name> (等級 <level> <race><class>)\n在<zone>溺斃",
	death_alert_default_slime_message = "<name> (等級 <level> <race><class>)\n在<zone>死於黏液",
	death_alert_default_lava_message = "<name> (等級 <level> <race><class>)\n在<zone>被岩漿燙死",
	death_alert_default_fire_message = "<name> (等級 <level> <race><class>)\n在<zone>被火燒死",
	death_alert_default_fatigue_message = "<name> (等級 <level> <race><class>)\n在<zone>過勞死",
	-- words
	corpse_word = "屍體",
	of_word = "屬於",
	minimap_btn_left_click = "|cFF666666左鍵:|r 打開筆記本",
	minimap_btn_right_click = "|cFF666666右鍵:|r 設定",
	class_word = "職業",
	killed_by_word = "死於",
	zone_instance_word = "區域/副本",
	date_word = "日期",
	last_words_word = "遺言",
	death_word = "死亡",
	guild_word = "公會",
	...
	tab_table = {
		{ value = "ClassStatisticsTab", text = "職業統計" },
		{ value = "CreatureStatisticsTab", text = "怪物統計" },
		{ value = "InstanceStatisticsTab", text = "副本統計" },
		{ value = "StatisticsTab", text = "區域統計" },
		{ value = "LogTab", text = "搜尋" },
		{ value = "WatchListTab", text = "追蹤名單" },
	},
	instance_tbl = {
		{ 33, "SHADOWFANGKEEP", "影牙城堡" },
		{ 36, "DEADMINES", "死亡礦坑" },
		{ 34, "STORMWINDSTOCKADES", "監獄" },
		{ 43, "WAILINGCAVERNS", "哀嚎洞穴" },
		{ 47, "RAZORFENKRAUL", "剃刀沼澤" },
		{ 48, "BLACKFATHOMDEEPS", "黑暗深淵" },
		{ 90, "GNOMEREGAN", "諾姆瑞根" },
		{ 189, "SCARLETMONASTERY", "血色修道院" },
		{ 70, "ULDAMAN", "奧達曼" },
		{ 109, "SUNKENTEMPLE", "沉沒的神廟" },
		{ 129, "RAZORFENDOWNS", "剃刀高地" },
		{ 209, "ZULFARAK", "祖爾法拉克" },
		{ 229, "BLACKROCKSPIRE", "黑石塔上層" },
		{ 230, "BLACKROCKDEPTHS", "黑石塔下層" },
		{ 289, "SCHOLOMANCE", "通靈學院" },
		{ 329, "STRATHOLME", "斯坦索姆" },
