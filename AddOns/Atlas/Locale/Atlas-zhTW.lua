...
L["ATLAS_CLICK_TO_OPEN"] = "點一下打開副本地圖"
L["ATLAS_CLOSE_ATLASLOOT_WINDOW"] = "右鍵點擊以關閉副本戰利品查詢視窗。"
L["ATLAS_COLLAPSE_BUTTON"] = "按下以收起副本地圖說明窗格。"
...
L["ATLAS_EXPAND_BUTTON"] = "按下以展開副本地圖說明窗格。"
...
右鍵 設定選項
左鍵並拖曳 移動圖示按鈕位置]=]
L["ATLAS_MISSING_MODULE"] = [=[副本地圖已偵測到遺失的模組／插件。

這有可能是因為先前您有過期的模組／插件而被副本地圖停用。
...
L["ATLAS_OPTIONS_CLAMPED_TIP"] = "使副本地圖視窗被拖曳時不會超出遊戲主畫面的邊界，關閉此選項則可將副本地圖視窗拖曳並超出遊戲畫面邊界"
...
L["ATLAS_ROPEN_ATLASLOOT_WINDOW"] = "右鍵點擊以開啟副本戰利品查詢視窗。"
