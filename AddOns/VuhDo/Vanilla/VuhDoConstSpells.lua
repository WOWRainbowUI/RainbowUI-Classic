...
VUHDO_SPELL_ID.BUFF_STRENGTH_OF_EARTH     = VUHDO_getSpellInfo(25361);
VUHDO_SPELL_ID.BUFF_STONECLAW_TOTEM       = VUHDO_getSpellInfo(10428);
VUHDO_SPELL_ID.BUFF_STONESKIN_TOTEM       = VUHDO_getSpellInfo(10408);
-- Water
...
-- Weapon Enchants
VUHDO_SPELL_ID.BUFF_ROCKBITER_WEAPON   = VUHDO_getSpellInfo(16316);
VUHDO_SPELL_ID.BUFF_WINDFURY_WEAPON    = VUHDO_getSpellInfo(25505);
VUHDO_SPELL_ID.BUFF_FLAMETONGUE_WEAPON = VUHDO_getSpellInfo(16342);
...
VUHDO_SPELL_ID.BUFF_OMEN_OF_CLARITY  = VUHDO_getSpellInfo(16864);
...
VUHDO_SPELL_ID.BUFF_MOLTEN_ARMOR       = VUHDO_getSpellInfo(428741);
...
-- SoD Rune Abilities
VUHDO_SPELL_ID.HELM_RUNE_ABILITY = VUHDO_getSpellInfo(417345);
VUHDO_SPELL_ID.CHEST_RUNE_ABILITY = VUHDO_getSpellInfo(399954);
VUHDO_SPELL_ID.LEGS_RUNE_ABILITY = VUHDO_getSpellInfo(399966);
VUHDO_SPELL_ID.HANDS_RUNE_ABILITY = VUHDO_getSpellInfo(399967);
VUHDO_SPELL_ID.WAIST_RUNE_ABILITY = VUHDO_getSpellInfo(415449);
VUHDO_SPELL_ID.FEET_RUNE_ABILITY = VUHDO_getSpellInfo(415450);
VUHDO_SPELL_ID.BRACER_RUNE_ABILITY = VUHDO_getSpellInfo(417346);
VUHDO_SPELL_ID.SHOULDER_RUNE_ABILITY = VUHDO_getSpellInfo(417348);
VUHDO_SPELL_ID.CLOAK_RUNE_ABILITY = VUHDO_getSpellInfo(417347);
