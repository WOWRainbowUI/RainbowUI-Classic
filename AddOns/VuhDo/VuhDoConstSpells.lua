...
VUHDO_SPELL_ID.ABSOLUTION = VUHDO_getSpellInfo(450761);
...
VUHDO_SPELL_ID.ANCESTRAL_VISION = VUHDO_getSpellInfo(450762);
...
VUHDO_SPELL_ID.BLOOD_PACT = VUHDO_getSpellInfo(6307);
...
VUHDO_SPELL_ID.CHAKRA = VUHDO_getSpellInfo(14751);
...
VUHDO_SPELL_ID.DIVINE_AEGIS = VUHDO_getSpellInfo(47509);
...
VUHDO_SPELL_ID.LUMINOUS_BARRIER = VUHDO_getSpellInfo(271466);
VUHDO_SPELL_ID.MANA_SHIELD = VUHDO_getSpellInfo(1463);
VUHDO_SPELL_ID.MASS_RESURRECTION = VUHDO_getSpellInfo(83968);
...
VUHDO_SPELL_ID.REVITALIZE = VUHDO_getSpellInfo(450759);
...
VUHDO_SPELL_ID.SACRED_SHIELD = VUHDO_getSpellInfo(85285);
...
VUHDO_SPELL_ID.BUFF_SHADOW_PROTECTION           = VUHDO_getSpellInfo(27683);
...
VUHDO_SPELL_ID.BUFF_FLAMETONGUE_TOTEM      = VUHDO_getSpellInfo(8227);
VUHDO_SPELL_ID.BUFF_TOTEM_OF_WRATH         = VUHDO_getSpellInfo(57658);
-- Air
VUHDO_SPELL_ID.BUFF_GROUNDING_TOTEM         = VUHDO_getSpellInfo(8177);
VUHDO_SPELL_ID.BUFF_WINDFURY                = VUHDO_getSpellInfo(8512);
VUHDO_SPELL_ID.BUFF_WRATH_OF_AIR            = VUHDO_getSpellInfo(3738);
VUHDO_SPELL_ID.BUFF_SOUL_LINK_TOTEM         = VUHDO_getSpellInfo(98008);
-- Earth
...
VUHDO_SPELL_ID.BUFF_STRENGTH_OF_EARTH     = VUHDO_getSpellInfo(8075);
VUHDO_SPELL_ID.BUFF_STONECLAW_TOTEM       = VUHDO_getSpellInfo(5730);
VUHDO_SPELL_ID.BUFF_STONESKIN_TOTEM       = VUHDO_getSpellInfo(8071);
-- Water
...
VUHDO_SPELL_ID.BUFF_MANA_SPRING_TOTEM          = VUHDO_getSpellInfo(5675);
VUHDO_SPELL_ID.BUFF_TOTEM_OF_TRANQUIL_MIND     = VUHDO_getSpellInfo(87718);
VUHDO_SPELL_ID.BUFF_ELEMENTAL_RESISTANCE_TOTEM = VUHDO_getSpellInfo(8184);
...
VUHDO_SPELL_ID.BUFF_NATURES_SWIFTNESS = VUHDO_getSpellInfo(16188);
...
VUHDO_SPELL_ID.BUFF_DEVOTION_AURA = VUHDO_getSpellInfo(465);
VUHDO_SPELL_ID.BUFF_RETRIBUTION_AURA = VUHDO_getSpellInfo(7294);
VUHDO_SPELL_ID.BUFF_CONCENTRATION_AURA = VUHDO_getSpellInfo(19746);
VUHDO_SPELL_ID.BUFF_RESISTANCE_AURA = VUHDO_getSpellInfo(19726);
VUHDO_SPELL_ID.BUFF_CRUSADER_AURA = VUHDO_getSpellInfo(32223);
...
-- Warlock
VUHDO_SPELL_ID.BUFF_DEMON_ARMOR = VUHDO_getSpellInfo(687);
VUHDO_SPELL_ID.BUFF_FEL_ARMOR = VUHDO_getSpellInfo(28176);
VUHDO_SPELL_ID.BUFF_DARK_INTENT = VUHDO_getSpellInfo(85767);
VUHDO_SPELL_ID.BUFF_SOUL_LINK = VUHDO_getSpellInfo(19028);
...
VUHDO_SPELL_ID.BUFF_ICE_ARMOR          = VUHDO_getSpellInfo(1214);
VUHDO_SPELL_ID.BUFF_DALARAN_BRILLIANCE = VUHDO_getSpellInfo(61316);
VUHDO_SPELL_ID.BUFF_FOCUS_MAGIC        = VUHDO_getSpellInfo(54646);
...
VUHDO_SPELL_ID.BUFF_VIGILANCE        = VUHDO_getSpellInfo(50720);
...
VUHDO_SPELL_ID.BUFF_ASPECT_OF_THE_WILD = VUHDO_getSpellInfo(20043);
